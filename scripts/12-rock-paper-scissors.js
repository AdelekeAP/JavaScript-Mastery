...
*/  
  ...
  let intervalId; // set outside as a new id would be created everytime a game is played if it within scope of if statement
    ...
    function autoPlay(){
      if(!isAutoPlaying){
        ...
        clearInterval(intervalId);  // so saved the Id then clear interval
        isAutoPlaying = false;
      }
    }
